...
class RemindersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reminder" do
    assert_difference('Reminder.count') do
      post reminders_url, params: { reminder: { message: @reminder.message, people: @reminder.people, sender: @reminder.sender, time: @reminder.time } }
    end
  ...
  test "should update reminder" do
    patch reminder_url(@reminder), params: { reminder: { message: @reminder.message, people: @reminder.people, sender: @reminder.sender, time: @reminder.time } }
